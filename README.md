...
then, run `grep -r -a "http://tailsbook.lan:6767" .`. it should give you a list of files with my current server ip in it. edit it to your ip/instance (Don't put a / at the end)
