...
var VastNativeBridge = /*#__PURE__*/function () {
  ...
  _createClass(VastNativeBridge, [{
    ...
    value: function disableCloseButton(disabled) {
      this.vast.disableCloseButton(disabled);
    }
  }, {
    key: "addIcon",
...
var Vast = /*#__PURE__*/function () {
  function Vast(options) {
    ...
    if (this.fullscreenButton) this.fullscreenButton.addEventListener('click', this._handleFullscreen.bind(this));
  }
  ...
  _createClass(Vast, [{
    ...
    key: "disableCloseButton",
    value: function disableCloseButton(disabled) {
      if (disabled) this._hideCloseButton();
      this.closeButtonDisabled = disabled;
    }
  }, {
    key: "addIcon",
    value: function addIcon(type, data) {
    ...
    value: function _showCloseButton() {
      if (this.closeButtonDisabled) return;
    ...
    value: function _hideCloseButton() {
      ...
      this._hideElement(this.closeButton);
    }
  }, {
    key: "_showMuteButton",
