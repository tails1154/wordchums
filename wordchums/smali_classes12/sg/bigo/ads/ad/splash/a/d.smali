...
.method static synthetic c(Lsg/bigo/ads/ad/splash/a/d;)V
    ...
    iget-object p0, p0, Lsg/bigo/ads/ad/splash/b;->v:Lsg/bigo/ads/ad/b/c;
...
.method public final a(ZLandroid/view/ViewGroup;I)V
    ...
    sput-boolean v3, Lsg/bigo/ads/ad/splash/a;->a:Z

    iput-boolean v3, p0, Lsg/bigo/ads/ad/splash/a/d;->t:Z

    sget p1, Lsg/bigo/ads/R$id;->inter_fl_interaction_container:I
    ...
    sget p3, Lsg/bigo/ads/R$layout;->bigo_ad_item_interaction_vertical:I

    iget-object v4, p0, Lsg/bigo/ads/ad/splash/a/b;->h:Lsg/bigo/ads/ad/splash/b;

    invoke-virtual {v4}, Lsg/bigo/ads/ad/splash/b;->getStyle()Lsg/bigo/ads/api/SplashAd$Style;

    move-result-object v4

    sget-object v5, Lsg/bigo/ads/api/SplashAd$Style;->HORIZONTAL:Lsg/bigo/ads/api/SplashAd$Style;

    if-ne v4, v5, :cond_0

    sget p3, Lsg/bigo/ads/R$layout;->bigo_ad_item_interaction_horizontal:I
    ...
    invoke-static {v4, p3, p1, v0}, Lsg/bigo/ads/common/utils/a;->a(Landroid/content/Context;ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    invoke-static {p3, v4}, Lsg/bigo/ads/common/utils/e;->a(Landroid/content/Context;I)I

    move-result p3

    int-to-float p3, p3

    invoke-virtual {v5, p3}, Landroid/view/View;->setTranslationY(F)V

    invoke-virtual {v5}, Landroid/view/View;->getTranslationY()F

    move-result p3

    invoke-static {v5, p3}, Lsg/bigo/ads/ad/splash/a;->a(Landroid/view/View;F)V
    ...
    :cond_9
    :goto_1
    sget p3, Lsg/bigo/ads/R$id;->bigo_ad_splash_media:I
    ...
    iget-object p3, p0, Lsg/bigo/ads/ad/splash/a/d;->u:Landroid/view/View$OnTouchListener;
    ...
    iget-object p3, p0, Lsg/bigo/ads/ad/splash/a/d;->m:Lsg/bigo/ads/common/q/b;
    ...
    :cond_c
    new-instance p2, Lsg/bigo/ads/common/q/b;
    ...
    invoke-direct {p2, p1, p3, v0}, Lsg/bigo/ads/common/q/b;-><init>(Landroid/content/Context;Ljava/util/List;Lsg/bigo/ads/common/q/a;)V

    iput-object p2, p0, Lsg/bigo/ads/ad/splash/a/d;->m:Lsg/bigo/ads/common/q/b;
