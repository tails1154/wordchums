...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "jsonData",
        "<init>",
        "(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/qg;Lorg/json/JSONObject;Ljava/lang/String;)V",
...
# direct methods
.method public constructor <init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/qg;Lorg/json/JSONObject;Ljava/lang/String;)V
    .locals 2
    .param p1    # Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    ...
    iput-object v0, p0, Lcom/ironsource/ws;->a:Landroid/os/Handler;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/ws;->b:Landroid/webkit/WebView;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/ws;->c:Landroid/webkit/WebView;

    iput-object p3, p0, Lcom/ironsource/ws;->d:Lorg/json/JSONObject;

    invoke-direct {p0, p1, p2, p4}, Lcom/ironsource/ws;->a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/qg;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic a(Lcom/ironsource/ws;)Landroid/os/Handler;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/ironsource/ws;->a:Landroid/os/Handler;

    return-object p0
.end method

.method private final a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/qg;Ljava/lang/String;)V
    .locals 3
    ...
    .line 4
    iget-object v0, p0, Lcom/ironsource/ws;->b:Landroid/webkit/WebView;
    ...
    :goto_1
    iget-object v0, p0, Lcom/ironsource/ws;->c:Landroid/webkit/WebView;
    ...
    iget-object v1, p0, Lcom/ironsource/ws;->a:Landroid/os/Handler;

    invoke-direct {v0, p1, v1}, Lcom/ironsource/js;-><init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Landroid/os/Handler;)V

    new-instance p1, Lcom/ironsource/ws$b;

    invoke-direct {p1, p0, p2}, Lcom/ironsource/ws$b;-><init>(Lcom/ironsource/ws;Lcom/ironsource/qg;)V

    iget-object v1, p0, Lcom/ironsource/ws;->c:Landroid/webkit/WebView;

    new-instance v2, Lcom/ironsource/ns;

    invoke-direct {v2, v0, p1, p0}, Lcom/ironsource/ns;-><init>(Lcom/ironsource/js;Lcom/ironsource/qg;Lcom/ironsource/os;)V
    ...
    iget-object p1, p0, Lcom/ironsource/ws;->c:Landroid/webkit/WebView;

    new-instance v0, Lcom/ironsource/ws$a;

    invoke-direct {v0, p0, p3}, Lcom/ironsource/ws$a;-><init>(Lcom/ironsource/ws;Ljava/lang/String;)V
    ...
    :cond_3
    :goto_2
    iget-object p1, p0, Lcom/ironsource/ws;->b:Landroid/webkit/WebView;
    ...
    :cond_4
    iget-object p1, p0, Lcom/ironsource/ws;->a:Landroid/os/Handler;

    new-instance p3, Lcom/ironsource/p00;

    invoke-direct {p3, p0}, Lcom/ironsource/p00;-><init>(Lcom/ironsource/ws;)V
    ...
    new-instance p3, Lcom/ironsource/q00;

    invoke-direct {p3, p2}, Lcom/ironsource/q00;-><init>(Lcom/ironsource/qg;)V
...
.method private static final a(Lcom/ironsource/qg;)V
    .locals 1
    ...
    invoke-interface {p0}, Lcom/ironsource/qg;->onUIReady()V

    return-void
.end method

.method private static final a(Lcom/ironsource/ws;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p0, p0, Lcom/ironsource/ws;->c:Landroid/webkit/WebView;
...
.method public static final synthetic a(Lcom/ironsource/ws;Z)V
    .locals 0

    .line 7
    iput-boolean p1, p0, Lcom/ironsource/ws;->e:Z

    return-void
.end method

.method public static synthetic b(Lcom/ironsource/qg;)V
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/ironsource/ws;->a(Lcom/ironsource/qg;)V

    return-void
.end method

.method public static final synthetic b(Lcom/ironsource/ws;)Z
    .locals 0

    .line 3
    iget-boolean p0, p0, Lcom/ironsource/ws;->e:Z

    return p0
.end method

.method public static final synthetic c(Lcom/ironsource/ws;)Lorg/json/JSONObject;
    .locals 0

    .line 3
    iget-object p0, p0, Lcom/ironsource/ws;->d:Lorg/json/JSONObject;

    return-object p0
.end method

.method public static synthetic c(Lcom/ironsource/ws;Ljava/lang/String;)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Lcom/ironsource/ws;->a(Lcom/ironsource/ws;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic d(Lcom/ironsource/ws;)Z
    .locals 0

    .line 2
    iget-boolean p0, p0, Lcom/ironsource/ws;->f:Z

    return p0
.end method

.method private static final e(Lcom/ironsource/ws;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/ironsource/ws;->f:Z

    return-void
.end method

.method public static synthetic f(Lcom/ironsource/ws;)V
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/ironsource/ws;->e(Lcom/ironsource/ws;)V
...
.method public final a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/ironsource/vs;->a:Lcom/ironsource/vs;

    invoke-virtual {v0, p2}, Lcom/ironsource/vs;->b(Ljava/util/List;)Ljava/lang/String;
...
.method public final a()V
    ...
    .line 3
    invoke-virtual {p0}, Lcom/ironsource/ws;->b()V
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/ironsource/ws;->a:Landroid/os/Handler;

    new-instance v1, Lcom/ironsource/r00;

    invoke-direct {v1, p0, p1}, Lcom/ironsource/r00;-><init>(Lcom/ironsource/ws;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;Ljava/util/List;)V
    ...
    iget-boolean v0, p0, Lcom/ironsource/ws;->e:Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/ironsource/ws;->a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/ironsource/ws;->a(Ljava/lang/String;)V
