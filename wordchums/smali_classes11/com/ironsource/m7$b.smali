...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/ironsource/m7;->a(Lcom/ironsource/lb;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
.end annotation
...
# direct methods
.method constructor <init>(Lcom/ironsource/m7;Lcom/ironsource/lb;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    .locals 0

    iput-object p1, p0, Lcom/ironsource/m7$b;->c:Lcom/ironsource/m7;

    iput-object p2, p0, Lcom/ironsource/m7$b;->a:Lcom/ironsource/lb;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/ironsource/m7$b;->a:Lcom/ironsource/lb;

    iget-object v1, p0, Lcom/ironsource/m7$b;->c:Lcom/ironsource/m7;

    invoke-static {v1}, Lcom/ironsource/m7;->b(Lcom/ironsource/m7;)Lcom/ironsource/kg;

    move-result-object v1

    invoke-interface {v1}, Lcom/ironsource/kg;->b()Ljava/lang/String;

    move-result-object v1

    const-string v2, "eventSessionId"

    invoke-virtual {v0, v2, v1}, Lcom/ironsource/lb;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v1}, Lcom/ironsource/kg;->c()I
    ...
    iget-object v2, p0, Lcom/ironsource/m7$b;->a:Lcom/ironsource/lb;

    invoke-virtual {v1, v2}, Lcom/ironsource/m7;->g(Lcom/ironsource/lb;)Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/ironsource/m7$b;->a:Lcom/ironsource/lb;

    const-string v2, "connectionType"

    invoke-virtual {v1, v2, v0}, Lcom/ironsource/lb;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v0, v2}, Lcom/ironsource/m7;->a(Lcom/ironsource/m7;Ljava/lang/String;Lcom/ironsource/lb;)Z
    ...
    invoke-static {v1, v0}, Lcom/ironsource/m7;->a(Lcom/ironsource/m7;Lcom/ironsource/lb;)I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/ironsource/lb;->a(I)V
    ...
    invoke-virtual {v1}, Lcom/ironsource/lb;->c()I
    ...
    invoke-static {v0, v1, v2}, Lcom/ironsource/m7;->a(Lcom/ironsource/m7;Lcom/ironsource/lb;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/ironsource/lb;->b()Lorg/json/JSONObject;
    ...
    invoke-virtual {v2, v3, v1}, Lcom/ironsource/lb;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v0, v1}, Lcom/ironsource/m7;->b(Lcom/ironsource/m7;Lcom/ironsource/lb;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/m7;->h(Lcom/ironsource/lb;)Z
    ...
    invoke-static {v0, v1}, Lcom/ironsource/m7;->c(Lcom/ironsource/m7;Lcom/ironsource/lb;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/m7;->c(Lcom/ironsource/lb;)I
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/m7;->j(Lcom/ironsource/lb;)Z
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/m7;->f(Lcom/ironsource/lb;)V

    :cond_7
    iget-object v0, p0, Lcom/ironsource/m7$b;->c:Lcom/ironsource/m7;

    invoke-static {v0}, Lcom/ironsource/m7;->b(Lcom/ironsource/m7;)Lcom/ironsource/kg;

    move-result-object v0

    invoke-interface {v0}, Lcom/ironsource/kg;->a()J
    ...
    invoke-virtual {v2, v1, v0}, Lcom/ironsource/lb;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lcom/ironsource/lb;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/m7;->d(Lcom/ironsource/lb;)Z
