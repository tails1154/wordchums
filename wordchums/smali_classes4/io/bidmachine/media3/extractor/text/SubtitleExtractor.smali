...
.field private final subtitleData:Lio/bidmachine/media3/common/util/ParsableByteArray;

.field private final subtitleDecoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
...
# direct methods
.method public constructor <init>(Lio/bidmachine/media3/extractor/text/SubtitleDecoder;Lio/bidmachine/media3/common/Format;)V
    .locals 1
    ...
    .line 4
    .line 5
    iput-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleDecoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    ...
    .line 11
    .line 12
    iput-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->cueEncoder:Lio/bidmachine/media3/extractor/text/CueEncoder;
    ...
    .line 18
    .line 19
    iput-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleData:Lio/bidmachine/media3/common/util/ParsableByteArray;
    ...
    .line 27
    .line 28
    invoke-virtual {p1, v0}, Lio/bidmachine/media3/common/Format$Builder;->setSampleMimeType(Ljava/lang/String;)Lio/bidmachine/media3/common/Format$Builder;
    ...
    .line 33
    .line 34
    invoke-virtual {p1, p2}, Lio/bidmachine/media3/common/Format$Builder;->setCodecs(Ljava/lang/String;)Lio/bidmachine/media3/common/Format$Builder;
    ...
    .line 47
    .line 48
    iput-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->timestamps:Ljava/util/List;
...
.method private decode()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleDecoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    ...
    .line 7
    .line 8
    check-cast v0, Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;
    ...
    .line 28
    :cond_0
    iget v3, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->bytesRead:I

    .line 29
    .line 30
    .line 31
    invoke-virtual {v0, v3}, Lio/bidmachine/media3/decoder/DecoderInputBuffer;->ensureSpaceForWrite(I)V

    .line 32
    .line 33
    iget-object v3, v0, Lio/bidmachine/media3/decoder/DecoderInputBuffer;->data:Ljava/nio/ByteBuffer;

    .line 34
    .line 35
    iget-object v4, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleData:Lio/bidmachine/media3/common/util/ParsableByteArray;
    ...
    .line 40
    .line 41
    iget v5, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->bytesRead:I
    ...
    .line 53
    .line 54
    iget-object v3, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleDecoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;

    .line 55
    .line 56
    .line 57
    invoke-interface {v3, v0}, Lio/bidmachine/media3/decoder/Decoder;->queueInputBuffer(Ljava/lang/Object;)V
    ...
    :cond_1
    :goto_2
    invoke-virtual {v0}, Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;->getEventTimeCount()I
    ...
    .line 87
    .line 88
    invoke-virtual {v0, v6}, Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;->getEventTime(I)J
    ...
    .line 91
    .line 92
    invoke-virtual {v0, v1, v2}, Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;->getCues(J)Ljava/util/List;
    ...
    .line 94
    .line 95
    iget-object v2, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->cueEncoder:Lio/bidmachine/media3/extractor/text/CueEncoder;

    .line 96
    .line 97
    .line 98
    invoke-virtual {v2, v1}, Lio/bidmachine/media3/extractor/text/CueEncoder;->encode(Ljava/util/List;)[B
    ...
    .line 100
    .line 101
    iget-object v2, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->timestamps:Ljava/util/List;
    ...
    .line 118
    .line 119
    invoke-direct {v3, v1}, Lio/bidmachine/media3/common/util/ParsableByteArray;-><init>([B)V
    ...
    .line 128
    :cond_2
    invoke-virtual {v0}, Lio/bidmachine/media3/decoder/DecoderOutputBuffer;->release()V
    :try_end_0
...
.method private readFromInput(Lio/bidmachine/media3/extractor/ExtractorInput;)Z
    ...
    .line 1
    .line 2
    iget-object v0, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleData:Lio/bidmachine/media3/common/util/ParsableByteArray;
    ...
    .line 26
    .line 27
    iget-object v2, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleData:Lio/bidmachine/media3/common/util/ParsableByteArray;

    .line 28
    .line 29
    .line 30
    invoke-virtual {v2}, Lio/bidmachine/media3/common/util/ParsableByteArray;->capacity()I
...
.method private writeToOutput()V
    ...
    .line 6
    .line 7
    iget-object v0, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->timestamps:Ljava/util/List;
    ...
    .line 42
    :cond_1
    iget-object v4, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->timestamps:Ljava/util/List;
    ...
    .line 48
    .line 49
    invoke-static {v4, v0, v3, v3}, Lio/bidmachine/media3/common/util/Util;->binarySearchFloor(Ljava/util/List;Ljava/lang/Comparable;ZZ)I
    ...
    .line 65
    .line 66
    check-cast v1, Lio/bidmachine/media3/common/util/ParsableByteArray;
    ...
    .line 75
    .line 76
    iget-object v3, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->trackOutput:Lio/bidmachine/media3/extractor/TrackOutput;

    .line 77
    .line 78
    .line 79
    invoke-interface {v3, v1, v8}, Lio/bidmachine/media3/extractor/TrackOutput;->sampleData(Lio/bidmachine/media3/common/util/ParsableByteArray;I)V

    .line 80
    .line 81
    iget-object v4, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->trackOutput:Lio/bidmachine/media3/extractor/TrackOutput;

    .line 82
    .line 83
    iget-object v1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->timestamps:Ljava/util/List;
...
.method public init(Lio/bidmachine/media3/extractor/ExtractorOutput;)V
    ...
    .line 13
    .line 14
    iput-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->extractorOutput:Lio/bidmachine/media3/extractor/ExtractorOutput;
    ...
    .line 17
    .line 18
    invoke-interface {p1, v1, v0}, Lio/bidmachine/media3/extractor/ExtractorOutput;->track(II)Lio/bidmachine/media3/extractor/TrackOutput;
    ...
    .line 20
    .line 21
    iput-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->trackOutput:Lio/bidmachine/media3/extractor/TrackOutput;

    .line 22
    .line 23
    iget-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->extractorOutput:Lio/bidmachine/media3/extractor/ExtractorOutput;
    ...
    .line 47
    .line 48
    invoke-direct {v0, v5, v6, v3, v4}, Lio/bidmachine/media3/extractor/IndexSeekMap;-><init>([J[JJ)V
    ...
    .line 52
    .line 53
    iget-object p1, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->trackOutput:Lio/bidmachine/media3/extractor/TrackOutput;

    .line 54
    .line 55
    iget-object v0, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->format:Lio/bidmachine/media3/common/Format;
...
.method public read(Lio/bidmachine/media3/extractor/ExtractorInput;Lio/bidmachine/media3/extractor/PositionHolder;)I
    ...
    .line 21
    .line 22
    iget-object p2, p0, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->subtitleData:Lio/bidmachine/media3/common/util/ParsableByteArray;
    ...
    .line 63
    .line 64
    invoke-direct {p0}, Lio/bidmachine/media3/extractor/text/SubtitleExtractor;->decode()V
