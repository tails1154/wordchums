...
.field private static b:Lcom/ironsource/ds;
...
.method private static a(Landroid/content/Context;)V
    ...
    .line 1
    sget-object v0, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/ds;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/ironsource/ds;->b()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/ds;->c()Z
...
.method private static a()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/ds;->a()Z
...
.method private static b(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/ds;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/ironsource/ds;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0, p0}, Lcom/ironsource/de;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/de;->t(Landroid/content/Context;)Ljava/io/File;
...
.method public static buildFilesMapOfDirectory(Lcom/ironsource/ag;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    invoke-direct {v4, v3}, Lcom/ironsource/ag;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4, p1}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->buildFilesMapOfDirectory(Lcom/ironsource/ag;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static c(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/de;->k(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/de;->v(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized deleteFile(Lcom/ironsource/ag;)Z
    .locals 2
...
.method public static ensurePathSafety(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/ds;->e()Z
...
.method public static getFilesInFolderRecursive(Lcom/ironsource/ag;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-static {v4}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getFilesInFolderRecursive(Lcom/ironsource/ag;)Ljava/util/ArrayList;
...
.method public static getTotalSizeOfDir(Lcom/ironsource/ag;)J
    .locals 6
    ...
    invoke-direct {v5, v4}, Lcom/ironsource/ag;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getTotalSizeOfDir(Lcom/ironsource/ag;)J
...
.method public static initializeCacheDirectory(Landroid/content/Context;Lcom/ironsource/ds;)V
    .locals 0
    .param p0    # Landroid/content/Context;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param
    .param p1    # Lcom/ironsource/ds;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    .end param

    sput-object p1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/ds;
...
.method public static readFile(Lcom/ironsource/ag;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static saveFile([BLjava/lang/String;)I
    ...
    invoke-static {v0}, Lcom/safedk/android/internal/partials/IronSourceFilesBridge;->fileOutputStreamCtor(Ljava/io/File;)Ljava/io/FileOutputStream;
