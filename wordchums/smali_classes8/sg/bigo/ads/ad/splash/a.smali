...
.method protected static a(ILsg/bigo/ads/ad/b/c;Landroid/view/ViewGroup;)V
    ...
    :cond_0
    invoke-static {p1, v1}, Lsg/bigo/ads/ad/interstitial/r;->a(Lsg/bigo/ads/api/NativeAd;I)I
...
.method private static b(Landroid/view/ViewGroup;)V
    ...
    sget v3, Lsg/bigo/ads/R$layout;->bigo_ad_splash_item_ripple:I

    const/4 v4, 0x0

    invoke-static {v2, v3, p0, v4}, Lsg/bigo/ads/common/utils/a;->a(Landroid/content/Context;ILandroid/view/ViewGroup;Z)Landroid/view/View;
...
.method public static b(Landroid/view/ViewGroup;I)V
    ...
    invoke-static {p1, v4, p0, v1}, Lsg/bigo/ads/common/utils/a;->a(Landroid/content/Context;ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    :cond_3
    invoke-static {p0, v1}, Lsg/bigo/ads/ad/splash/a;->b(Landroid/view/ViewGroup;Z)V

    return-void

    :cond_4
    invoke-static {p0, v1}, Lsg/bigo/ads/ad/splash/a;->a(Landroid/view/ViewGroup;Z)V
...
.method static synthetic c(Landroid/view/ViewGroup;I)V
    ...
    :cond_0
    sget v6, Lsg/bigo/ads/R$id;->bigo_ad_splash_cta_inner:I
    ...
    invoke-static {p1, v10, p0, v5}, Lsg/bigo/ads/common/utils/a;->a(Landroid/content/Context;ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    :cond_3
    invoke-static {p0, v4}, Lsg/bigo/ads/ad/splash/a;->b(Landroid/view/ViewGroup;Z)V

    return-void

    :cond_4
    invoke-static {p0, v4}, Lsg/bigo/ads/ad/splash/a;->a(Landroid/view/ViewGroup;Z)V
    ...
    invoke-static {p1, v0, p0, v4}, Lsg/bigo/ads/common/utils/a;->a(Landroid/content/Context;ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    invoke-static {v11, p0}, Landroid/animation/Keyframe;->ofFloat(FF)Landroid/animation/Keyframe;
    ...
    invoke-static {p0, v1}, Landroid/animation/PropertyValuesHolder;->ofKeyframe(Ljava/lang/String;[Landroid/animation/Keyframe;)Landroid/animation/PropertyValuesHolder;
    ...
    new-array v10, v3, [Landroid/animation/Keyframe;
    ...
    invoke-static {p0, v10}, Landroid/animation/PropertyValuesHolder;->ofKeyframe(Ljava/lang/String;[Landroid/animation/Keyframe;)Landroid/animation/PropertyValuesHolder;
    ...
    new-array v12, v3, [Landroid/animation/Keyframe;
    ...
    new-array v9, v3, [Landroid/animation/Keyframe;
    ...
    invoke-static {v0, v9}, Landroid/animation/PropertyValuesHolder;->ofKeyframe(Ljava/lang/String;[Landroid/animation/Keyframe;)Landroid/animation/PropertyValuesHolder;
