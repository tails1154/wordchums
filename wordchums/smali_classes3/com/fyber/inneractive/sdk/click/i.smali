...
.method public final a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)Lcom/fyber/inneractive/sdk/click/b;
    ...
    .line 16
    :cond_2
    sget-object v3, Lcom/fyber/inneractive/sdk/util/F;->OPEN_EVERYTHING:Lcom/fyber/inneractive/sdk/util/F;
    ...
    .line 23
    new-instance v6, Lcom/fyber/inneractive/sdk/util/D;

    sget-object v7, Lcom/fyber/inneractive/sdk/util/G;->OPEN_IN_EXTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/util/G;

    invoke-direct {v6, v7, v4}, Lcom/fyber/inneractive/sdk/util/D;-><init>(Lcom/fyber/inneractive/sdk/util/G;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :catchall_1
    :try_start_4
    invoke-static {v2}, Lcom/fyber/inneractive/sdk/util/H;->d(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_5

    invoke-static {v2}, Lcom/fyber/inneractive/sdk/util/H;->c(Ljava/lang/String;)Z
    ...
    .line 25
    sget-object v6, Lcom/fyber/inneractive/sdk/util/F;->DO_NOT_OPEN_IN_INTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/util/F;
    ...
    sget-object p1, Lcom/fyber/inneractive/sdk/util/G;->OPENED_IN_INTERNAL_BROWSER:Lcom/fyber/inneractive/sdk/util/G;

    invoke-direct {v6, p1, v4}, Lcom/fyber/inneractive/sdk/util/D;-><init>(Lcom/fyber/inneractive/sdk/util/G;Ljava/lang/Throwable;)V
    ...
    sget-object p1, Lcom/fyber/inneractive/sdk/util/G;->FAILED:Lcom/fyber/inneractive/sdk/util/G;
    ...
    invoke-direct {v3, v5}, Lcom/fyber/inneractive/sdk/util/E;-><init>(Ljava/lang/String;)V

    invoke-direct {v6, p1, v3}, Lcom/fyber/inneractive/sdk/util/D;-><init>(Lcom/fyber/inneractive/sdk/util/G;Ljava/lang/Throwable;)V

    goto :goto_4

    .line 34
    :catch_1
    invoke-static {p1, v2}, Lcom/fyber/inneractive/sdk/util/H;->a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    sget-object p1, Lcom/fyber/inneractive/sdk/util/G;->OPENED_USING_CHROME_NAVIGATE:Lcom/fyber/inneractive/sdk/util/G;
    ...
    invoke-direct {v6, v3, p1}, Lcom/fyber/inneractive/sdk/util/D;-><init>(Lcom/fyber/inneractive/sdk/util/G;Ljava/lang/Throwable;)V

    :goto_4
    if-eqz p3, :cond_8

    .line 39
    iget-object p1, v6, Lcom/fyber/inneractive/sdk/util/D;->b:Ljava/lang/Throwable;
