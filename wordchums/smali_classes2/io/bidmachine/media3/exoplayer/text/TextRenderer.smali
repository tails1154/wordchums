...
# instance fields
.field private decoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private final decoderFactory:Lio/bidmachine/media3/exoplayer/text/SubtitleDecoderFactory;
...
.field private nextInputBuffer:Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Lio/bidmachine/media3/exoplayer/text/TextOutput;Landroid/os/Looper;Lio/bidmachine/media3/exoplayer/text/SubtitleDecoderFactory;)V
    ...
    .line 5
    iput-object p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoderFactory:Lio/bidmachine/media3/exoplayer/text/SubtitleDecoderFactory;
    ...
    .line 8
    iput-wide p1, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->outputStreamOffsetUs:J
...
.method private getCurrentEventTimeUs(J)J
    ...
    .line 45
    .line 46
    iget-wide p1, p1, Lio/bidmachine/media3/decoder/DecoderOutputBuffer;->timeUs:J
...
.method private getPresentationTimeUs(J)J
    ...
    .line 18
    .line 19
    iget-wide v5, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->outputStreamOffsetUs:J
    ...
    .line 28
    .line 29
    iget-wide v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->outputStreamOffsetUs:J
...
.method private handleDecoderError(Lio/bidmachine/media3/extractor/text/SubtitleDecoderException;)V
    ...
    .line 29
    .line 30
    invoke-direct {p0}, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->replaceDecoder()V
...
.method private initDecoder()V
    ...
    .line 4
    .line 5
    iget-object v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoderFactory:Lio/bidmachine/media3/exoplayer/text/SubtitleDecoderFactory;
    ...
    .line 18
    .line 19
    iput-object v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
...
.method private releaseBuffers()V
    ...
    .line 2
    .line 3
    iput-object v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;
...
.method private releaseDecoder()V
    ...
    .line 2
    .line 3
    invoke-direct {p0}, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->releaseBuffers()V

    .line 4
    .line 5
    iget-object v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    ...
    .line 13
    .line 14
    invoke-interface {v0}, Lio/bidmachine/media3/decoder/Decoder;->release()V
...
.method private replaceDecoder()V
    ...
    .line 2
    .line 3
    invoke-direct {p0}, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->releaseDecoder()V

    .line 4
    .line 5
    .line 6
    invoke-direct {p0}, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->initDecoder()V
...
.method protected onDisabled()V
    ...
    .line 14
    .line 15
    iput-wide v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->outputStreamOffsetUs:J
...
.method protected onPositionReset(JZ)V
    ...
    .line 29
    .line 30
    iget-object p1, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    ...
    .line 38
    .line 39
    invoke-interface {p1}, Lio/bidmachine/media3/decoder/Decoder;->flush()V
...
.method protected onStreamChanged([Lio/bidmachine/media3/common/Format;JJ)V
    ...
    .line 1
    .line 2
    iput-wide p4, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->outputStreamOffsetUs:J
    ...
    .line 13
    .line 14
    iput p1, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoderReplacementState:I
...
.method public render(JJ)V
    ...
    .line 4
    .line 5
    invoke-virtual {p0}, Lio/bidmachine/media3/exoplayer/BaseRenderer;->isCurrentStreamFinal()Z
    ...
    .line 10
    .line 11
    iget-wide v0, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->finalStreamEndPositionUs:J
    ...
    .line 28
    .line 29
    iput-boolean p4, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->outputStreamEnded:Z
    ...
    .line 37
    :cond_1
    iget-object p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextSubtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;
    ...
    .line 40
    .line 41
    iget-object p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    ...
    .line 46
    .line 47
    check-cast p3, Lio/bidmachine/media3/extractor/text/SubtitleDecoder;

    .line 48
    .line 49
    .line 50
    invoke-interface {p3, p1, p2}, Lio/bidmachine/media3/extractor/text/SubtitleDecoder;->setPositionUs(J)V
    ...
    .line 60
    .line 61
    invoke-interface {p3}, Lio/bidmachine/media3/decoder/Decoder;->dequeueOutputBuffer()Ljava/lang/Object;
    ...
    .line 63
    .line 64
    check-cast p3, Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;

    .line 65
    .line 66
    iput-object p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextSubtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;
    :try_end_0
    ...
    .line 83
    :cond_3
    iget-object p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->subtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;
    ...
    .line 96
    .line 97
    iget p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextSubtitleEventIndex:I
    ...
    .line 99
    .line 100
    iput p3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextSubtitleEventIndex:I
    ...
    .line 109
    :cond_5
    iget-object v2, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextSubtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;
    ...
    .line 134
    .line 135
    iget v2, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoderReplacementState:I
    ...
    .line 149
    :cond_7
    iget-wide v4, v2, Lio/bidmachine/media3/decoder/DecoderOutputBuffer;->timeUs:J
    ...
    .line 159
    .line 160
    invoke-virtual {p3}, Lio/bidmachine/media3/decoder/DecoderOutputBuffer;->release()V

    .line 161
    .line 162
    .line 163
    :cond_8
    invoke-virtual {v2, p1, p2}, Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;->getNextEventTimeIndex(J)I
    ...
    .line 167
    .line 168
    iput-object v2, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->subtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;

    .line 169
    .line 170
    iput-object v3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextSubtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;
    ...
    .line 184
    .line 185
    invoke-direct {p0, v4, v5}, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->getPresentationTimeUs(J)J
    ...
    .line 187
    .line 188
    new-instance p3, Lio/bidmachine/media3/common/text/CueGroup;

    .line 189
    .line 190
    iget-object v2, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->subtitle:Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;

    .line 191
    .line 192
    .line 193
    invoke-virtual {v2, p1, p2}, Lio/bidmachine/media3/extractor/text/SubtitleOutputBuffer;->getCues(J)Ljava/util/List;
    ...
    .line 196
    .line 197
    invoke-direct {p3, p1, v4, v5}, Lio/bidmachine/media3/common/text/CueGroup;-><init>(Ljava/util/List;J)V

    .line 198
    .line 199
    .line 200
    invoke-direct {p0, p3}, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->updateOutput(Lio/bidmachine/media3/common/text/CueGroup;)V
    ...
    .line 211
    .line 212
    iget-object p1, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;
    ...
    .line 224
    .line 225
    invoke-interface {p1}, Lio/bidmachine/media3/decoder/Decoder;->dequeueInputBuffer()Ljava/lang/Object;
    ...
    .line 233
    :cond_c
    iput-object p1, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;
    ...
    .line 243
    .line 244
    invoke-virtual {p1, p2}, Lio/bidmachine/media3/decoder/Buffer;->setFlags(I)V

    .line 245
    .line 246
    iget-object p2, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->decoder:Lio/bidmachine/media3/extractor/text/SubtitleDecoder;
    ...
    .line 254
    .line 255
    invoke-interface {p2, p1}, Lio/bidmachine/media3/decoder/Decoder;->queueInputBuffer(Ljava/lang/Object;)V

    .line 256
    .line 257
    iput-object v3, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->nextInputBuffer:Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;
    ...
    .line 264
    .line 265
    invoke-virtual {p0, p2, p1, v1}, Lio/bidmachine/media3/exoplayer/BaseRenderer;->readSource(Lio/bidmachine/media3/exoplayer/FormatHolder;Lio/bidmachine/media3/decoder/DecoderInputBuffer;I)I
    ...
    .line 276
    .line 277
    iput-boolean p4, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->inputStreamEnded:Z

    .line 278
    .line 279
    iput-boolean v1, p0, Lio/bidmachine/media3/exoplayer/text/TextRenderer;->waitingForKeyFrame:Z
    ...
    .line 289
    :cond_10
    iget-wide p2, p2, Lio/bidmachine/media3/common/Format;->subsampleOffsetUs:J

    .line 290
    .line 291
    iput-wide p2, p1, Lio/bidmachine/media3/extractor/text/SubtitleInputBuffer;->subsampleOffsetUs:J
