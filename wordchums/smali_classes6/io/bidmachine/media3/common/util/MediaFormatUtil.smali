...
.method public static createFormatFromMediaFormat(Landroid/media/MediaFormat;)Lio/bidmachine/media3/common/Format;
    ...
    .line 120
    .line 121
    invoke-static {p0, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getColorInfo(Landroid/media/MediaFormat;Z)Lio/bidmachine/media3/common/ColorInfo;
    ...
    .line 190
    .line 191
    invoke-virtual {v0, p0}, Lio/bidmachine/media3/common/Format$Builder;->setInitializationData(Ljava/util/List;)Lio/bidmachine/media3/common/Format$Builder;
...
.method public static createMediaFormatFromFormat(Lio/bidmachine/media3/common/Format;)Landroid/media/MediaFormat;
    ...
    .line 11
    .line 12
    invoke-static {v0, v2, v1}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetInteger(Landroid/media/MediaFormat;Ljava/lang/String;I)V
    ...
    .line 149
    .line 150
    iget p0, p0, Lio/bidmachine/media3/common/Format;->pixelWidthHeightRatio:F

    .line 151
    .line 152
    .line 153
    invoke-static {v0, p0}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->maybeSetPixelAspectRatio(Landroid/media/MediaFormat;F)V
...
.method public static getColorInfo(Landroid/media/MediaFormat;)Lio/bidmachine/media3/common/ColorInfo;
    ...
    .line 1
    invoke-static {p0, v0}, Lio/bidmachine/media3/common/util/MediaFormatUtil;->getColorInfo(Landroid/media/MediaFormat;Z)Lio/bidmachine/media3/common/ColorInfo;
...
.method private static getColorInfo(Landroid/media/MediaFormat;Z)Lio/bidmachine/media3/common/ColorInfo;
    .locals 6
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    :cond_6
    :goto_1
    new-instance p1, Lio/bidmachine/media3/common/ColorInfo$Builder;

    invoke-direct {p1}, Lio/bidmachine/media3/common/ColorInfo$Builder;-><init>()V

    .line 15
    invoke-virtual {p1, v0}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorSpace(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object p1

    .line 16
    invoke-virtual {p1, v3}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorRange(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object p1

    .line 17
    invoke-virtual {p1, v4}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setColorTransfer(I)Lio/bidmachine/media3/common/ColorInfo$Builder;

    move-result-object p1

    .line 18
    invoke-virtual {p1, p0}, Lio/bidmachine/media3/common/ColorInfo$Builder;->setHdrStaticInfo([B)Lio/bidmachine/media3/common/ColorInfo$Builder;
